...
<template>
    <div>
        <div v-if="userInfo && paymentInfo"
            class="font-noto-sans-thai bg-[url('../assets/background/dormBackground.png')] bg-cover bg-center w-full h-310">
            <div class="h-20"></div>
            <div class="relative flex items-center p-10">
                <RouterLink to="/profile">
                    <button type="button"
                        class="absolute bottom-10 left-10 flex items-center justify-center cursor-pointer">
                ...
                <div class="w-full flex justify-center">
                    <h1
                        class="text-white text-7xl font-noto-sans-thai font-bold text-center drop-shadow-[4px_4px_2px_rgba(0,0,0,0.5)]">
                        จ่ายบิลหอพัก
                    </h1>
                </div>
            </div>
            <div class="flex justify-center items-center text-center space-x-15">
                <div
                    class="rounded-3xl p-10 h-230 w-130 bg-[#1E555C] flex flex-col space-y-8 text-[#ffffff] text-3xl text-left font-semibold">
                    <div class="flex items-center justify-center">
                        <div
                            class="absolute border-5 border-[#E09F3E] w-15 h-15 bg-[#ffffff] rounded-full flex items-center justify-center mb-20 shadow-md shadow-gray-800">
                ...
                <div
                    ...
                    <div class="text-3xl font-bold">{{ costFormat((paymentInfo.report.electricity) +
                        (paymentInfo.report.rent)) + ".00" }} ฿</div>
                    <div>
                        <img :src="`./payments/qrcode.png`" alt="qrcode" class="w-40">
                    </div>
                    <div>หมายเหตุ : การชำระเงินผ่านทาง QR Code <br> จะใช้เวลาในการอัปเดตข้อมูลการชำระเงินประมาณ 1-2 วัน
                    </div>
                    ...
                    <div>
                        <button
                            class="w-100 h-16 border-gray-300 border-2 rounded-lg flex justify-center items-center cursor-pointer hover:bg-gray-200 transition-all duration-500 ease-in-out">
        ...
        <div v-if="paymentInfo === undefined" class=" w-full h-110 font-noto-sans-thai">
            <div
                class="pt-40 flex flex-col items-center justify-center p-8 text-center rounded-lg  bg-white">
                ...
                <h3 class="text-xl font-medium mb-2">คุณยังไม่มีรายการที่ต้องชำระ</h3>
                <p class="text-gray-500 mb-4">เมื่อคุณมีรายการที่ต้องชำระ รายการจะแสดงที่นี่</p>
            </div>
        </div>
    </div>
</template>
