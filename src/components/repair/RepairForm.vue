...
<template>
  <div
    class="p-10 w-[900px] mx-auto bg-white rounded-3xl border-[#9DB5B2] border-2 shadow-md font-noto-sans-thai flex flex-col">
    ...
    <div class="flex flex-wrap justify-between items-center gap-2">
      ...
      <div class="mt-4">
        ...
        <Dropdown label="ประเภทงาน" :list="repairTypeOptions"
      ...
      <div>
        ...
        <div>
          <label class="block text-[#1E555C] text-lg font-noto-sans-thai">รายละเอียด การชำรุดเสียหาย<span
      ...
      <div class="flex space-x-9">
        <div>
          ...
          <Input label="วันนัดหมาย (mm/dd/yyyy)" inputType="date" v-model="newRepair.appointmentDate"
            :required="true" />
        </div>
        ...
        <div>
          ...
          <Dropdown label="เวลานัดหมาย" :list="timeOptions"
            :placeholder="newRepair.appointmentTime ? newRepair.appointmentTime : 'โปรดเลือกเวลานัดหมาย'"
            v-model="newRepair.appointmentTime" :required="true" />
        </div>
      </div>
    </div>
